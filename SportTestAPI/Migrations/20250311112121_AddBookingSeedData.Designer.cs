...
namespace SportTestAPI.Migrations
{
    ...
    [Migration("20250311112121_AddBookingSeedData")]
            ...
            modelBuilder.Entity("SportTestAPI.DataModels.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "acb2aa2c-cc92-424d-b5ff-2cc3f1e7f9a4",
                            Contact = "",
                            Email = "KK@GMAIL.COM",
                            ...
                            ProfilePicture = "",
                            Role = "Admin",
                            SecurityStamp = "e077680f-8af7-4699-813f-a4e3e8c2e0f2",
                        ...
                        new
                        {
                            Id = "143",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2f8e173f-64e6-4707-8532-b15857f860ab",
                            Contact = "",
                            Email = "KK@GMAIL.COM",
                            EmailConfirmed = false,
                            FullName = "Jane Doe",
                            ...
                            ProfilePicture = "",
                            Role = "User",
                            SecurityStamp = "f63e0991-062c-48c9-b585-baca6d5d1ff7",
                            TwoFactorEnabled = false,
                            UserName = "janedoe"
                        });
                });
            ...
            modelBuilder.Entity("SportTestAPI.DataModels.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            InvoiceID = 1,
                            Amount = 100m,
                            DateIssued = new DateTime(2025, 3, 11, 12, 21, 21, 304, DateTimeKind.Local).AddTicks(2352),
                            PaymentMethod = "",
                            Status = "Active",
                            UserID = "123"
                        },
                        new
                        {
                            InvoiceID = 2,
                            Amount = 150m,
                            DateIssued = new DateTime(2025, 3, 11, 12, 21, 21, 304, DateTimeKind.Local).AddTicks(2410),
                            PaymentMethod = "",
                            Status = "DeActive",
                            UserID = "143"
                        });
            ...
            modelBuilder.Entity("SportTestAPI.DataModels.Match", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MatchID = 1,
                            Date = new DateTime(2025, 3, 11, 12, 21, 21, 304, DateTimeKind.Local).AddTicks(2628),
                            Player1ID = "123",
                            Player2ID = "143",
                            Score = "20",
                            TournamentID = 1
            ...
            modelBuilder.Entity("SportTestAPI.DataModels.TrainingSession", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AgeGroupID = 1,
                            CoachID = 1,
                            Date = new DateTime(2025, 3, 11, 12, 21, 21, 304, DateTimeKind.Local).AddTicks(2603),
                            DayOfWeek = "1",
                            Duration = 0,
                            Fee = 0m,
                            InvoiceID = 1,
                        ...
                        new
                        {
                            ...
                            AgeGroupID = 2,
                            CoachID = 2,
                            Date = new DateTime(2025, 3, 11, 12, 21, 21, 304, DateTimeKind.Local).AddTicks(2609),
                            DayOfWeek = "1",
                            Duration = 0,
                            Fee = 0m,
                            InvoiceID = 2,
